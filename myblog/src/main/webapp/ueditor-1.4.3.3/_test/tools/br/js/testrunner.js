                ...
                if (tests) {
                    ...
                    if (bad) {
                        ...
                        if (toolbar) {
                            ...
                            id("qunit-mefilter-pass").disabled = null;
                            id("qunit-mefilter-missing").disabled = null;
                        }
                    }
...
// object exists, in that case we assume we're in CommonJS
    ...
    addEvent(window, "load", function () {
        ...
        if (toolbar) {
            ...
            label.setAttribute("for", "qunit-mefilter-pass");
            label.innerHTML = "Hide passed tests";
            toolbar.appendChild(label);

            var missing = document.createElement("input");
            missing.type = "checkbox";
            missing.id = "qunit-mefilter-missing";
            ...
            label.setAttribute("for", "qunit-mefilter-missing");
