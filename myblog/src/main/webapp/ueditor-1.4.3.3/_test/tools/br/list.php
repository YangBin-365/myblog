...
//被测&统计概率的部分
$mefilter = array_key_exists( 'mefilter' , $_GET ) ? $_GET[ 'mefilter' ] : '*';
//跑的用例
$filterRun = array_key_exists( 'filterRun' , $_GET ) ? $_GET[ 'filterRun' ] : $mefilter;
...
<?php
    ...
    Kiss::listcase( $mefilter ,$filterRun );
    ?>
